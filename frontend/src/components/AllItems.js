...
export default function AllItems() {
    ...
    const [total, settotPrice] = useState("");


    useEffect(() => {
        function getItems() {
            axios.get("http://localhost:8072/labitemsinventory/item").then((res) => {
    ...
    function handleAddItems(item) {
        ...
        axios
            .put("http://localhost:8072/labitemsinventory/updateItem/" + item._id, updateItem)
            .then(() => {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Total Price</h5>
                    ...
                    <tbody>
                        {items.map((itm) => (
                            ...
                            <tr className="tr-in" key={itm._id}>
                                ...
                                <button type="button" className="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal" onClick={() => settotPrice(itm.quantity * itm.noOfitem)}>
  Total Price
</button>
                                ...
                                <td className="td-in"><button className="update1 btn-sm"><a href={"/updateItem/" + itm._id}style={{ color: 'white' }}>Update</a></button></td>
                                <td className="td-in"><button className="delete1 btn-sm"><a href={"/deleteItem/" + itm._id} style={{ color: 'white' }}>Delete</a></button></td>
