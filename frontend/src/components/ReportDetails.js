...
export default function ReportDetails() {
    ...
    useEffect(function () {
        ...
        function getBloodReports() {
            axios.get("http://localhost:8072/bloodreport/blood").then((res) => {
    ...
    useEffect(function () {
        ...
        function getReports() {
            axios.get("http://localhost:8072/report/").then((res) => {
                console.log(res.data);
                setReports(res.data)
            }).catch((err) => {
                alert(err.message);
                                    ...
                                    <div className="out" ref={down}>
                                        ...
                                        <div className="card1" id="num">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <center><img height={"300px"} width={"500px"} src={`http://localhost:8072/images/${rep.filepath}`} /></center><br></br><br></br>
