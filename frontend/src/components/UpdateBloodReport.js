...
export default function UpdateBloodReport() {
    ...
    useEffect(() => {
        function getBloodReports() {
            axios.get("http://localhost:8072/bloodreport/getBlood/" + id).then((res) => {
    ...
    function handle(e) {
        ...
        axios.put("http://localhost:8072/bloodreport/updateBlood/" + id, UpdateBloodReport).then(function () {
