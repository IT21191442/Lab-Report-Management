...
export default function UpdateItem() {
  ...
  const decNum = () =>{
    ...
    useEffect(() => {
        function getItems() {
            axios.get("http://localhost:8072/labitemsinventory/getItem/" + id).then((res) => {
    ...
    function handle(e) {
        ...
        axios.put("http://localhost:8072/labitemsinventory/updateItem/" + id, UpdateItems).then(function () {
